...
import type { ContentRoutingConfig } from '../../../dist/app/main'
...
export interface ModuleOptions {
   ...
   * Use this when @nuxtjs/i18n is installed and Studio doesn't auto-detect the routing strategy.
   */
  content?: {
    /**
     * Routing configuration for localized content.
     * This is used to match routes to content files when using @nuxtjs/i18n.
     */
    routing?: {
      /**
      ...
      /**
       * The default locale for content routing.
       * If not set, will be auto-detected from @nuxtjs/i18n.
       */
      defaultLocale?: string
      /**
